            ...
            <>
                <section className='min-h-[100dvh] md:min-h-screen flex flex-col items-center justify-center text-center space-y-10'>
                    ...
                    <div className='space-y-2 mt-3'>
                        <h1 className='text-xl font-medium'>Sorry Buddy! You are not authorized</h1>
                        <p className="text-muted-foreground">It looks like you&apos;ve reached a URL that you can&apos;t visit.</p>
                    </div>
